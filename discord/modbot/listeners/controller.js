...
const buttonFiles = grabFiles("./discord/modbot/listeners/button/")
const modalSubmitFiles = grabFiles("./discord/modbot/listeners/modalSubmit/")
const selectMenuFiles = grabFiles("./discord/modbot/listeners/selectMenu/")
...
for (const file of buttonFiles) {
    ...
    if ("name" in listener && "verify" in listener && "listener" in listener) {
        ...
        console.error("Listener " + file + " is missing an attribute!");
}
